...
class QuasiLinearTest(sciunit.Test, BinaryScore, OverallBinaryScore):
    ...
    def generate_prediction(self, model, verbose=False):
        ...
        self.ramp_up_down_currents = \
                { "current1": {"amp": 0.2, "dur": 1000.0, "delay": 300.0},
                  "current2": {"amp": 0.4, "dur": 1000.0, "delay": 2300.0},
                  "current3": {"amp": 0.5, "dur": 1000.0, "delay": 3300.0},
                  "current4": {"amp": 0.4, "dur": 1000.0, "delay": 4300.0},
                  "current5": {"amp": 0.2, "dur": 1000.0, "delay": 5300.0},
