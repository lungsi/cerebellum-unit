...
class QuasiLinearTest(sciunit.Test, BinaryScore, OverallBinaryScore):
    ...
    def generate_prediction(self, model, verbose=False):
        ...
        self.ramp_up_down_currents = \
                { "current1": {"amp": 0.2, "dur": 50.0, "delay": 50.0},
                  "current2": {"amp": 0.4, "dur": 50.0, "delay": 100.0},
                  "current3": {"amp": 0.5, "dur": 50.0, "delay": 200.0},
                  "current4": {"amp": 0.4, "dur": 50.0, "delay": 300.0},
                  "current5": {"amp": 0.2, "dur": 50.0, "delay": 400.0},
