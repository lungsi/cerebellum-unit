...
class SpontaneousFiringTest(sciunit.Test, BinaryScore):
    ...
    def compute_score(self, observation, model, verbose=False):
        ...
        if score.score==1:
            ans = "The model " + model.name + " passed the  SpontaneousFiringTest. The mean firing rate of the model = " + str(a_prediction) + " and the validation data is " + str(observation)
        else:
            ans = "The model " + model.name + " failed the SpontaneousFiringTest. The mean firing rate of the model = " + str(a_prediction) + " and the validation data is " + str(observation)
        print ans
        return score
        #computed_scores = {}
        #for cell_region in model.cell_regions:
